...
extern "C" {
#endif
#undef at_o2xfs_xfs_XfsAPI_WFS_INDEFINITE_WAIT
#define at_o2xfs_xfs_XfsAPI_WFS_INDEFINITE_WAIT 0i64
/*
 * Class:     at_o2xfs_xfs_XfsAPI
 * Method:    loadLibrary
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_at_o2xfs_xfs_XfsAPI_loadLibrary
  (JNIEnv *, jobject);
