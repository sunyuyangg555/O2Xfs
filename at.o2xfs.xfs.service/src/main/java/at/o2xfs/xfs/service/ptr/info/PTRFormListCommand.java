...
public class PTRFormListCommand implements Callable<String[]> {

    private final PTRService ptrService;

    public PTRFormListCommand(PTRService ptrService) {
    ...
    public String[] call() throws Exception {
        XfsInfoCommand<PtrInfoCommand>  command = new XfsInfoCommand<>(ptrService, PtrInfoCommand.FORM_LIST);
