...
public class OpenShutterCommand extends AbstractAsyncXfsCommand<CommandListener<SuccessEvent>, SuccessEvent> {

    private final CimService cimService;
    private final Pointer position;

    public OpenShutterCommand(CimService cimService, Pointer position) {
    ...
    protected XfsCommand createCommand() {
        return new XfsExecuteCommand<>(cimService, CimExecuteCommand.OPEN_SHUTTER, position);
    }
