...
public class EjectSlotOut extends Struct {
    ...
    protected EjectSlotOut() {
        add(type);
        add(cmdData);
    }

    public EjectSlotOut(Pointer p) {
        this();
        assignBuffer(p);
    }

    public EjectSlotOut(EjectSlotOut copy) {
        this();
        allocate();
        set(copy);
    }

    private void set(EjectSlotOut copy) {
    ...
    public boolean equals(Object o) {
        ...
        EjectSlotOut ejectSlot = (EjectSlotOut) o;
