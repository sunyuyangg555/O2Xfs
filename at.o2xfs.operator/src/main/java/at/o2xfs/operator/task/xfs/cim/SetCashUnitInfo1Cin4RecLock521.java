...
public class SetCashUnitInfo1Cin4RecLock521 extends SetCashUnitInfoTask {

    @Override
    protected CashIn3[] getCashIns() {

        return new CashIn3[]{
                createCashIn3(1, "1A", 0, true, CashInType.RECYCLING, CashInItemType.INDIVIDUAL),
    ...
    protected Class getTaskClass() {
        return SetCashUnitInfo1Cin4RecLock521.class;
    }
}
