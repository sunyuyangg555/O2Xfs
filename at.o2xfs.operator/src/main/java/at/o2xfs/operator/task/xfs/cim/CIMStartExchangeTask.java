...
import at.o2xfs.xfs.v3_00.cim.NumberCashUnitArray;
...
public class CIMStartExchangeTask extends CIMServiceTask {
    ...
    protected void execute() {
        ...
        NumberCashUnitArray numberCashUnitArray = new NumberCashUnitArray(ushorts);
        ...
        StartEx3 startEx3 = new StartEx3.Builder(ExchangeType.CLEARRECYCLER, 0, numberCashUnitArray, output3Array).build();
