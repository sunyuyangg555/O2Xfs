...
import at.o2xfs.xfs.service.cim.execute.SetCashUnitInfoListener;
import at.o2xfs.xfs.service.cmd.event.CancelEvent;
import at.o2xfs.xfs.service.cmd.event.ErrorEvent;
import at.o2xfs.xfs.service.cmd.event.SuccessEvent;
import reactor.core.publisher.FluxSink;

public class SetCashUnitInfoAdapter extends CimExeAdapter implements SetCashUnitInfoListener {

    public SetCashUnitInfoAdapter(FluxSink fluxSink) {
        super(fluxSink);
    }
